...
class MiMOVSSwitch( OVSSwitch ):
    ...
    def add_mim_flows( self, source, target, mim, use_ipv6=True ):
        ...
        ### IPV6
            ...
            # TODO: fix, this should have higher priority compared to the next flow
            # udp = nw_proto 17, fix: 
            self.cmd("ovs-ofctl", "add-flow", "s1", "dl_type=0x86dd,ipv6_src=%s,in_port=2,nw_proto=17,tp_dst=%d,actions=mod_tp_dst:%d,output:3" % (targetIPV6, 15118, 15119))
