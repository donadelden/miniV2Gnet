...
function v2g {
    ...
    if [ "$DIST" = "Arch Linux" ]; then
      ...
      echo "Downloading $LINK1 and $LINK2"; sudo curl -L -O --output $MININET_DIR/mininet/util/RiseV2G $LINK1; sudo curl -L -O --output $MININET_DIR/mininet/util/RiseV2G $LINK2;
